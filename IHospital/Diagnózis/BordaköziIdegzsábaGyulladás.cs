...
{
    class BordaköziIdegzsábaGyulladás : IGyulladás
    {
        public string Típus = "Bordaközi Idegzsába Gyulladás";
        ...
        public BordaköziIdegzsábaGyulladás(Súlyosság súlyosság, int időtartam, bool váladék, GyulladásMérték mérték, string hely)
        {
